...
module.exports = {
  ...
  summary:
    ...
    "data-heavy web platforms. Every project below is publicly live and can be opened and inspected.",
  ...
  projects: [
    ["PropInfo", "propinfo.com.au", "Multi-tenant SaaS for Australian buyer's agents. Claude API property assessments, financial modelling, CRM, RBAC. Next.js, TypeScript, Supabase."],
    ...
    ["iventicks", "eventicket-psi.vercel.app", "Event ticketing platform. Payments, fraud detection, refunds, payouts, live check-in, PWA."],
    ["Strategic Buys", "strategicbuys.com.au", "Property advisory site built as a six-scene scroll-scrubbed film, server-rendered."],
    ["Asprey Lawyers", "aspreylawyers.com", "Melbourne law firm site in six languages. Next.js 15, React 19, Tailwind v4."],
    ["Nikunj", "nikunj.com.au", "Sponsorship platform for a racing driver. Sanity CMS, Supabase, GA4."],
    ["NVRGVP", "nvrgvp.org", "Content-led site with country-resolved provider logic, structured for search."],
  ],

  internal: [
    ["ChargeCore", "Charge point management for off-grid solar EV charging on a CitrineOS fork with OCPP. Metering, session billing, tariff logic."],
    ["access-audit", "Headless WCAG 2.2 AA scanner on Playwright and axe-core. Dated, hash-verified evidence records; fingerprints overlay vendors by script signature."],
  ],
